    ...
    <>
      <div className="hero">
        <section className="hero__section container">
          <h1 id="header">
            Empower content, Unleash possibilities <br /> with ultimate <text id="purple__text">headless
            CMS</text>
          </h1>
          <p id="paragraph">
          ...
          <div className="hero__btn">
            ...
            <button className="btn" id="create__btn">Create Headless for your project</button>
          </div>
        </section>
      </div>
    </>
